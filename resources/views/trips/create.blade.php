            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('trips.store') }}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('crew_phone') is-invalid @enderror" id="crew_phone" name="crew_phone" value="{{ old('crew_phone') }}" placeholder="Enter crew phone number">
                                @error('crew_phone')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('crew_address') is-invalid @enderror" id="crew_address" name="crew_address" rows="3" placeholder="Enter crew address">{{ old('crew_address') }}</textarea>
                        @error('crew_address')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
