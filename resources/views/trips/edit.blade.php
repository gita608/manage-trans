...
@section('title', 'Edit Trip | ' . config('app.name', 'Laravel'))
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('crew_name') is-invalid @enderror" id="crew_name" name="crew_name" value="{{ old('crew_name', $trip->crew_name) }}" placeholder="Enter crew name" required>
                                @error('crew_name')
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('trip_date') is-invalid @enderror" id="trip_date" name="trip_date" value="{{ old('trip_date', $trip->trip_date->format('Y-m-d')) }}" required>
                                @error('trip_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('vessel_id') is-invalid @enderror" id="vessel_id" name="vessel_id" required>
                                    ...
                                    @foreach($vessels as $vessel)
                                        <option value="{{ $vessel->id }}" {{ old('vessel_id', $trip->vessel_id) == $vessel->id ? 'selected' : '' }}>{{ $vessel->name }}</option>
                                    @endforeach
                                </select>
                                @error('vessel_id')
                                    <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="time" class="form-control @error('pick_up_time') is-invalid @enderror" id="pick_up_time" name="pick_up_time" value="{{ old('pick_up_time', \Carbon\Carbon::parse($trip->pick_up_time)->format('H:i')) }}" required>
                                @error('pick_up_time')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('from_location') is-invalid @enderror" id="from_location" name="from_location" value="{{ old('from_location', $trip->from_location) }}" placeholder="Enter pick-up location" required>
                                @error('from_location')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('to_location') is-invalid @enderror" id="to_location" name="to_location" value="{{ old('to_location', $trip->to_location) }}" placeholder="Enter destination location" required>
                                @error('to_location')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
